...
abstract class FlutterFlowTheme {
  ...
  late Color fundoVerdeTransp;
  late Color fundoVermelhoTransp;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFAB2D00);
  late Color secondary = const Color(0xFFFF7851);
  late Color tertiary = const Color(0x33FF7851);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF2D2F31);
  late Color secondaryText = const Color(0xFF5A5C5E);
  late Color primaryBackground = const Color(0xFFF9F9F9);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF0096CC);
  late Color accent2 = const Color(0x4C51D1FF);
  late Color accent3 = const Color(0xFF8F009C);
  late Color accent4 = const Color(0x4CFFA7EC);
  late Color success = const Color(0xFF007716);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFAB0000);
  late Color info = const Color(0xFFFFFFFF);

  late Color terciaryText = const Color(0xFFACADAF);
  late Color quarternaryText = const Color(0xFF757779);
  late Color fundoVerdeTransp = const Color(0x4D007716);
  late Color fundoVermelhoTransp = const Color(0x4EDC2626);
  late Color foundationBlack = const Color(0xFF212427);
  late Color foundationStarbucksGreenStarbucksGreen900 =
