...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    sistemaDeGestaoSLFOODAuthUserSubject.add(
      SistemaDeGestaoSLFOODAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SistemaDeGestaoSLFOODAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SistemaDeGestaoSLFOODAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SistemaDeGestaoSLFOODAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    sistemaDeGestaoSLFOODAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SistemaDeGestaoSLFOODAuthUser? currentUser;
