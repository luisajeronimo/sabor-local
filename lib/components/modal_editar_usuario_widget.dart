...
import 'modal_editar_usuario_model.dart';
export 'modal_editar_usuario_model.dart';

class ModalEditarUsuarioWidget extends StatefulWidget {
  const ModalEditarUsuarioWidget({
    super.key,
  ...
  @override
  State<ModalEditarUsuarioWidget> createState() =>
      _ModalEditarUsuarioWidgetState();
}

class _ModalEditarUsuarioWidgetState extends State<ModalEditarUsuarioWidget>
    with TickerProviderStateMixin {
  late ModalEditarUsuarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalEditarUsuarioModel());
