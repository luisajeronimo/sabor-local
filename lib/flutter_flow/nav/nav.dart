...
class AppStateNotifier extends ChangeNotifier {
  ...
  SistemaDeGestaoSLFOODAuthUser? initialUser;
  SistemaDeGestaoSLFOODAuthUser? user;
  ...
  void update(SistemaDeGestaoSLFOODAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? PainelDeGestaoWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn
              ? PainelDeGestaoWidget()
              : LoginWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: DefinirNovaSenhaWidget.routeName,
          path: DefinirNovaSenhaWidget.routePath,
          builder: (context, params) => DefinirNovaSenhaWidget(
        ...
        FFRoute(
          name: GestaoDePapeisWidget.routeName,
          path: GestaoDePapeisWidget.routePath,
          builder: (context, params) => GestaoDePapeisWidget(),
        ),
        FFRoute(
          name: MenuProdutosWidget.routeName,
          path: MenuProdutosWidget.routePath,
